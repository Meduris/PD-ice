...
public class ShatteredPixelDungeon extends Game {
	...
	@SuppressLint("NewApi")
	public static void counterLandscape(boolean value) {
		Preferences.INSTANCE.put(Preferences.KEY_COUNTER_LANDSCAPE, value);

		if (android.os.Build.VERSION.SDK_INT >= 9) {
			try {
				Game.instance
						.setRequestedOrientation(value ? ActivityInfo.SCREEN_ORIENTATION_REVERSE_LANDSCAPE
	...
	public static boolean counterLandscape() {
		return Preferences.INSTANCE.getBoolean(
				Preferences.KEY_COUNTER_LANDSCAPE, false);
	}
